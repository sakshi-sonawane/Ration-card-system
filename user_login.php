              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4" > <b>  User Login
                    </b> </h1>
                  </div>
...
// echo "clicked!!";
      ...
      $query_check1="SELECT * from customer_registeration where c_email ='$customer_Email' && c_password='$customer_Password' ";
