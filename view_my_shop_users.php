<?php include "user_includes/shop_heder.php" ;?>
    ...
    <br>
            ...
            <tbody>
                    <?php
                 $shop_id= $_GET["emp_id"] ;  
                    $query  = "SELECT * FROM assign_to_user where shop_id = '$shop_id' ";
                    ...
                    $query_name  = "SELECT * FROM customer_registeration WHERE customer_id = ' $customer_id'";
