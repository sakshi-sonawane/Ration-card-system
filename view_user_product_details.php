<?php include "user_includes/header.php" ;?>
    ...
    <br>
            ...
            <tbody>
                    <?php
                     $customer_id= $_GET["emp_id"] ;    
                    $query  = "SELECT * FROM assign_to_user where customer_id= '$customer_id' ";
                    ...
                    $query_name  = "SELECT * FROM customer_registeration WHERE customer_id = '$user_id'";
