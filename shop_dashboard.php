              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">My Customer</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                       <?php
                        $query = "SELECT * FROM assign_to_user where shop_id =$shop_session_id  ";
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">1200Rs</div>
                        </div>
                        <div class="col">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Assigned Products</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                        $query = "SELECT * FROM assign_to_user where shop_id =$shop_session_id  ";
                        $result = mysqli_query($connection,$query);
